...
public class Assign4 {
	public static void main(String[] args) throws IOException {
		// Read in commandline arguments, should be an input and output file
		...
		List<List<String[]>> allLines = new ArrayList<>(){{add(lines1);add(lines2);add(lines3);add(lines4);add(lines5);}};
